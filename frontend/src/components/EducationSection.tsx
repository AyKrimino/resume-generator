  ...
  return (
    <section className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        ...
        <div key={index} className="mb-6 p-4 bg-gray-50 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="px-3 py-1 bg-red-100 text-red-800 rounded-md hover:bg-red-200 transition-colors delay-150 cursor-pointer"
            >
              Remove
            </button>
          </div>
      ...
      <button
        ...
        className="w-full px-4 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      >
        + Add Education
      </button>
    </section>
